...
<html lang="en">
  ...
  <body>
        <h1 class="text-center mb-5 text-decoration-underline fst-italic">Personajes de Star Wars</h1>
        <div class="container">
            <form class="col-3" action="buscar.php" method="GET">
                <div class="form-group">
                  <label for="">Buscar Personajes de Star Wars</label>
                ...
                <?php foreach($personajes as $personaje) {  ?>
                   <div class="col-4">
                        <div class="card mb-2" style="width: 18rem;">
                                ...
                                <div class="card-body">
                                    <h5 class="card-title text-center"><?= $personaje->getNombre_completo(); ?></h5>
                                </div>
                                <div class="card-body">
