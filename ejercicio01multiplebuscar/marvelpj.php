<?php
    ...
    require_once "classes/Marvel.php";

  //Instanciar los objeto
    $miObjetoPersonaje = new Marvel();
    $marvel = $miObjetoPersonaje->lista_completa();
  ...
  <body>
        ...
        <div class="container">
            ...
            <div class="d-flex justify-content-center">
                <a class="btn btn-warning" href="index.php">DC</a>
            </div>

            <div class="row mt-5">
                <?php foreach($marvel as $personaje) {  ?>
                   <div class="col-3">
